...
filename = 'Data.xlsx'
thisdir = os.getcwd()
if os.path.isdir("PureComponentData"):
    os.chdir("PureComponentData")
df = {}
df["Critical"] = pd.read_excel(filename, sheet_name = "Critical") #xl_file.parse("Critical")
df["LiqDens"] = pd.read_excel(filename, sheet_name = "LiqDens") #xl_file.parse("LiqDens")
df["Pvap"] = pd.read_excel(filename, sheet_name = "Pvap") #xl_file.parse("Pvap")
df["Hvap"] = pd.read_excel(filename, sheet_name = "Hvap") #xl_file.parse("Hvap")
df["CpIG"] = pd.read_excel(filename, sheet_name = "CpIG") #xl_file.parse("CpIG")
df["HandGf"] = pd.read_excel(filename, sheet_name = "HandGf") #xl_file.parse("HandGf")
os.chdir(thisdir)
